...
int main() {
    ...
    PRINT(CAM_INTF_PARM_VENDOR_01,    pMetadata);
    PRINT(CAM_INTF_PARM_VENDOR_02,    pMetadata);
    PRINT(CAM_INTF_PARM_VENDOR_03,    pMetadata);
    PRINT(CAM_INTF_PARM_VENDOR_04,    pMetadata);
    PRINT(CAM_INTF_PARM_VENDOR_05,    pMetadata);
    PRINT(CAM_INTF_PARM_VENDOR_06,    pMetadata);
    PRINT(CAM_INTF_PARM_VENDOR_07,    pMetadata);
    PRINT(CAM_INTF_PARM_VENDOR_08,    pMetadata);
    PRINT(CAM_INTF_PARM_VENDOR_09,    pMetadata);
    PRINT(CAM_INTF_PARM_VENDOR_10,    pMetadata);
    PRINT(CAM_INTF_PARM_VENDOR_11,    pMetadata);
    PRINT(CAM_INTF_PARM_VENDOR_12,    pMetadata);
    PRINT(CAM_INTF_PARM_VENDOR_13,    pMetadata);
    PRINT(CAM_INTF_PARM_VENDOR_14,    pMetadata);
    PRINT(CAM_INTF_PARM_VENDOR_15,    pMetadata);
    PRINT(CAM_INTF_PARM_VENDOR_16,    pMetadata);
    PRINT(CAM_INTF_PARM_VENDOR_17,    pMetadata);
    PRINT(CAM_INTF_PARM_VENDOR_18,    pMetadata);
    PRINT(CAM_INTF_PARM_VENDOR_19,    pMetadata);
    PRINT(CAM_INTF_PARM_VENDOR_20,    pMetadata);
    PRINT(CAM_INTF_PARM_VENDOR_21,    pMetadata);
    PRINT(CAM_INTF_PARM_VENDOR_22,    pMetadata);
    PRINT(CAM_INTF_PARM_VENDOR_23,    pMetadata);
    PRINT(CAM_INTF_PARM_VENDOR_24,    pMetadata);
    PRINT(CAM_INTF_PARM_VENDOR_25,    pMetadata);
    PRINT(CAM_INTF_PARM_VENDOR_26,    pMetadata);
    PRINT(CAM_INTF_PARM_VENDOR_27,    pMetadata);
    PRINT(CAM_INTF_PARM_VENDOR_28,    pMetadata);
    PRINT(CAM_INTF_PARM_VENDOR_29,    pMetadata);
    PRINT(CAM_INTF_PARM_VENDOR_30,    pMetadata);
